            ...
            <div className={"grid grid-cols-2 mt-24"}>
                ...
                <div className={"justify-self-start"}>
                    ...
                    {games.name ? (<div className={"flex place-content-center mt-20"}>
                        <svg className={"stroke-black hover:stroke-secondary cursor-pointer"} onClick={handleAdd} width="30" height="30" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
